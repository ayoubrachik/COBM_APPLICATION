...
$sql_type= "select * from type_recette";
...
if(!isset($type))
    ...
    if($type!="tous")
    {
        $sql1 .= "SELECT * FROM recette R INNER join type_recette T on R.ID_type=T.ID_type where R.ID_type= $type ";
        
    }
    else
    {
        $sql1 .= "SELECT * FROM recette R INNER join type_recette T on R.ID_type=T.ID_type ";
    }
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-3">
                <div style="text-align: center;" class="form-group">
                    <label  >Type Recette:</label>
                    <select class="js-example-basic-single form-control " name="ID_recette" onchange="window.location.href='Recette.php?type='+this.value">
            ...
            <div style="text-align: center;" class="col-md-6">
                <label>Actions:</label>
                <div>
                        <a href="new_Recette.php"><button type="button" class="btn btn-success">Nouvelle Recette</button></a>
                ...
                <table id="myTable" class=" table-bordered table-striped">
                            ...
                            while($row1 = mysqli_fetch_array($result1))
                            {
                                ...
                                ';
                                    ...
                                    $ID_recette_del=$row1['ID_recette'];
                                    
                                    
                                    $output .= "<td><a  href='#'><i class='fas fa-print inline'></i></a>";
                                    $output .= "<a onclick='deleting3(`$ID_recette_del`)' href='#'><i class='fas fa-trash-alt inline '></i></a></td>";
                                    $output .= "</tr>";
