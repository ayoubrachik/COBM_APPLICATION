...
<form action="insert_recette.php">
            ...
            <div class="card-info">
                ...
                <div class="card-body">
                    <div  class="form-group">
                        <label>Type Recette<span>(*)</span></label>
                        <select class="js-example-basic-single form-control " name="ID_recette">
                            <option value="0" disabled selected >selectionner Type Recette</option>
                    ...
                    <div  class="form-group">
                        ...
                        <textarea name="description" class="form-control" name="" id="" cols="10" rows="4"></textarea>
                            ...
                            <div style="padding:15px;" class="col-ms-6">
                            <a href="Recette.php"><button type="button" class="btn btn-danger">Retour</button></a>
                            </div>
                </div>
                </div>
